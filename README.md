# bsp-grinn-astra-1680-sbc

Board support for Grinn Astra 1680 SBC

## Using this extension

`bsp-grinn-astra-1680-sbc` is an [Avocado](https://avocadolinux.org) extension — a reusable fragment of
...
```yaml
extensions:
  avocado-bsp-grinn-astra-1680-sbc:
    source:
      type: package
